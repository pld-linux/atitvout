...
Summary(pl.UTF-8):   Program do obsługi wyjścia TV-out w kartach ATI
Name:		atitvout
Version:	0.4
Release:	2
License:	GPL
...
Program pozwalający ustawiać różne parametry wyjścia TV-out w kartach
graficznych na układach ATI.
